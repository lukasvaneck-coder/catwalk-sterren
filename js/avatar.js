...
const Avatar = (() => {
  ...
  const HAIR = {
    ...
    zijstaart: { front: c => `<path d="M198 84 Q240 140 218 256" stroke="${c.hairFill}" stroke-width="24" stroke-linecap="round" fill="none"/>${shine(c, 'M206 100 Q232 150 220 230')}<path d="${CAP} Q198 72 150 68 Q102 72 92 104 Z" fill="${c.hairFill}"/><circle cx="202" cy="92" r="7" fill="#ff5da2"/>${strands(c, 'M120 70 Q136 58 150 56 M112 88 Q120 74 132 68')}` },
